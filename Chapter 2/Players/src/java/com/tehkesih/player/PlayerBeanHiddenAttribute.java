...
@Named
@RequestScoped
public class PlayerBeanHiddenAttribute {
    
    private ArrayList<Player> dataArrayList = new ArrayList<>();
    final SimpleDateFormat sdf = new SimpleDateFormat("dd.MM.yyyy");
    
    public PlayerBeanHiddenAttribute(){
        try {
            ...
            Logger.getLogger(PlayerBeanHiddenAttribute.class.getName()).log(Level.SEVERE, null, ex);
        }
